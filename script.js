...
footer.href = "https://www.instagram.com/zulfhanmt/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Neng Ciman", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
